...
// dispatchQueueTagAction handles queue tag-related actions.
func (s *Service) dispatchQueueTagAction(action string, w http.ResponseWriter, r *http.Request) {
	switch action {
	case "ListQueueTags":
		s.ListQueueTags(w, r)
	case "TagQueue":
...
func (s *Service) DispatchAction(w http.ResponseWriter, r *http.Request) {
	...
	case "CreateQueue":
		s.CreateQueue(w, r)
	case "ListQueueTags", "TagQueue", "UntagQueue":
		s.dispatchQueueTagAction(action, w, r)
	case "DeleteQueue":
		s.DeleteQueue(w, r)
	case "ListQueues":
		s.ListQueues(w, r)
