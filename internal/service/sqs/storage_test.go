...
func TestMemoryStorage_TagsLifecycle(t *testing.T) {
	...
	err = s.TagQueue(ctx, "http://kumo:4566/000000000000/tagged-queue", map[string]string{"key2": "val2", "key1": "updated"})
	if err != nil {
	...
	if len(tags) != 2 || tags["key1"] != "updated" || tags["key2"] != "val2" {
